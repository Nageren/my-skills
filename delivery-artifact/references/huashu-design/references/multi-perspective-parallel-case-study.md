...
- ~~完整方法论：`references/launch-film-director-notes.md`~~ —— 已 scope-cut（delivery-artifact 集成不含 launch-film 工作流，见 huashu-design.md 顶部通告）
- ~~单视角样本：`assets/director-notes-samples/launch-film-30s-sample.md`（v5 基线）~~ —— 已 scope-cut（同上）
